...
public class SplashScreen extends JWindow {
     ...
     * @param tex1
     */
    public SplashScreen(Texture tex, Texture tex1){
        this.imgIcon = new ImageIcon(tex.getImage());
        this.imgIcon1 = new ImageIcon(tex1.getImage());
    ...
    public void setProgress(int progress){
        ...
        SwingUtilities.invokeLater(new Runnable(){
            @Override
            public void run(){
                if(progress == progressBar.getMaximum()/2) imgLabel.setIcon(imgIcon1);
