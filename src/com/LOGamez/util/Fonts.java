...
public class Fonts {
    ...
    */
    public static void drawString(Graphics g, Font f, Color c, String text){
        ...
        int x = MazeGenerator.getMainWidth() - fm.stringWidth(text) / 2;// Horizontal centre
        int y = ((MazeGenerator.getMainHeight() - fm.getHeight()) / 2) + fm.getAscent();// Vertical centre
